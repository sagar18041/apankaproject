		...
		<div class="span8">
			<div id="tabs">
				...
				<div id="tabs-2">
					<p>
							...
							<div style="margin-left: 10px;">
								<input type="radio" name="shippingorder" checked="true"
									style="vertical-align: middle; margin-top: -2px;">Single
								Order Shipping (SOS) <br />
								<br /> <input type="radio" name="shippingorder"
						...
						<s:form action="emaillogin">
									...
									<table class="table">
										...
										<tr>
											...
											<td><s:select name="shippingState" list="stateList"
													value="--Select State--" style="font-size: 12px" /></td>
										</tr>
										<tr>
							...
							<s:iterator value="existingAddrList" status="addrTick">
								...
								<a href="#" data-toggle="tooltip" data-placement="top"
									title="<s:property />">Address <s:property
				...
				<%-- <table class="table table-bordered" >
							<tr><td>PRODUCT 1 ::</td><td><font style="font-size: 12px;">Shipping Addresses</font>&nbsp;
											<s:select name="shipping" list="existingAddrList"
													headerKey="-1" headerValue="--Select Shipping Address--" cssStyle="font-size: 12px; " /></td></tr>
							<tr><td>PRODUCT 2 ::</td><td><font style="font-size: 12px;">Shipping Addresses</font>&nbsp;
											<s:select name="shipping" list="existingAddrList"
													value="--Select State--" cssStyle="font-size: 12px" /></td></tr>
							</table> --%>
				</s:form>
				</p>
			</div>
