...
<body>
	...
	<div class="row-fluid">
		...
		<div class="span3"
			...
			<a href="#" class="thumbnail"> <img src="ViewResources/img/1.jpg"
	...
	<div class="row-fluid"
		...
		<div class="span4"
			...
			<s:iterator value="recentlyViewedItems">
				<div class="row-fluid">
					<div class="span4">
						<a href="displayitem.action?itemID=<s:property value = "itemID"/>">
							<img src="<s:property value = "thumbnail"/>" height="40px"
							width="40px">
						</a>
					</div>
					<div class="span8">
						<a href="displayitem.action?itemID=<s:property value = "itemID"/>"><s:property
