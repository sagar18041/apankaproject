...
<body>
	<div class=container-fluid>
		...
		<div class="row-fluid">
			<div class="span3">
				<div class="acct">
					...
					<ul class="nav nav-list">
						...
						<li class="divider"></li>
						<li class="active"><b>&nbsp;&nbsp;&nbsp;&nbsp;Update Email</b></li>
						<li class="dividerbottom"></li>
					</ul>
				</div>
			</div>
			...
			<div class="span9">
				<h3>Update Email</h3><br/><br/>
				<b>Enter the new Email ID that you wish to associate with your Flipkart account.</b><br/><br/>
				<div align="center">
					<s:form action="modifyemail" method="post">
						<table class="table">
							<tbody>
								...
								<tr>
									<td
										style='text-align: left; vertical-align: middle; font-size: 14px'>New Email ID</td>
									<td
