...
<script>
	...
	function timedRedirect(value) {
		...
		document.getElementById(value).innerHTML = "<div align='center' style='background-color: #D4EFF8; width: 250px; height: 300px;font-size: 16px'><br><br><br><br><br><b>Deleting...</b></div>";
	...
	<div class=container-fluid>
		...
		<div class="row-fluid">
			...
			<div class="span6">
				...
				<b>Your Saved Addresses</b> <br /> <br /> <font
					style="font-size: 12px"> <s:iterator value="addressList">
